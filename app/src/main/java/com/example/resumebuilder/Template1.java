...
//        });
        ...
        adapter1 = new EduTempAdapter(Template1.this, R.layout.listeducation, edutempArrayList);
        ...
        adapter2 = new ExpTempAdapter(Template1.this, R.layout.listexperience, exptempArrayList);
        ...
        adapter3 = new SkillTempAdapter(Template1.this, R.layout.listskill, skilltempArrayList);
        ...
        PdfGenerator.getBuilder()
                ...
                .build(new PdfGeneratorListener() {
                    ...
                    public void onFailure(FailureResponse failureResponse) {
                        ...
                        Toast.makeText(Template1.this, "" + failureResponse.getErrorMessage(), Toast.LENGTH_LONG).show();
                    ...
                    public void onFinishPDFGeneration() {
                        Toast.makeText(Template1.this, "done", Toast.LENGTH_SHORT).show();
                    }
